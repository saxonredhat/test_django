...
urlpatterns = [
	...
	path('publisher_books/<int:pk>/', views.PublisherBookList.as_view(),name='publisher_book_list'),
	...
	path('author/<int:pk>/interest/',views.RecordInterest.as_view(),name='author-interest'),
